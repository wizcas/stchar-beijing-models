...
**角色过滤规则**
- 仅提取"拍摄任务"中包含的模特
- 优先使用角色"昵称"进行匹配，如不存在则用"真名"匹配
- 如果没有拍摄任务或角色不在任务模特列表中，该角色将被略过
...
```xml
<context>
{"世界":{"时间":"2024-12-16T14:30:00+0800","地点":"[北京]昌平仓库工作室"},"用户":{"拍摄任务":[...],"资金":10000,"堕落度":0},"女模":{"六花":{"好感度":0,"堕落度":0,"动情程度":null,"尺度":null,"人设":null}}}
</context>
```
